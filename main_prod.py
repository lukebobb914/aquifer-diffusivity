...
# if __name__ == '__main__': 
    # main('OW511', 'mitlenatch', ([os.path.join(data_folder, "Annual_Predictions_Mitlenatch_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Mitlenatch_2024.csv")], False),
    #      shore_x_col, shore_y_col, 3.2, os.path.join(data_folder, "MASL_OW511.csv"), well_x_col, well_y_col, 100, [0.030, 23, 4.5, 0.9], fit_fn, 155, 12.67*3600, 20, 5) 
    # main('OW408', ([os.path.join(data_folder, "Annual_Predictions_Mitlenatch_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Mitlenatch_2024.csv")], False),
    #      shore_x_col, shore_y_col, 3.2, os.path.join(data_folder, "MASL_OW408.csv"), well_x_col, well_y_col, 100, [0.030, 23, 4.5, 0.9], fit_fn, 306, 12.67*3600, 1, 1.1) 
    # main('OW452', ([os.path.join(data_folder, "08MH0047.csv")], True), 'Timestamp (UTC)', 'Value (m)', 0, os.path.join(data_folder, "MASL_OW452.csv"),
    #      well_x_col, well_y_col, 100, [0.030, 23, 4.5, 0.9], fit_fn, 681, 12.67*3600, 8, 1.4) 
    # main('OW499', ([os.path.join(data_folder, "Annual_Predictions_Roberts Creek_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Roberts Creek_2024.csv")], False),
    #      shore_x_col, shore_y_col, 1.23, os.path.join(data_folder, "MASL_OW499.csv"), well_x_col, well_y_col, 100, [0.030, 23, 4.5, 0.9], fit_fn, 782, 12.67*3600, 8, 0.7) 
    # main('OW473', ([os.path.join(data_folder, "Annual_Predictions_Point Atkinson_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Point Atkinson_2024.csv")], False),
    #     shore_x_col, shore_y_col, -86, os.path.join(data_folder, "MASL_OW473.csv"), well_x_col, well_y_col, 100, None, composite_sine, 280, 12.67*3600, 8, 1) 
    

#%%
# if __name__ == '__main__': 

#     # shore_df = import_shore_data([os.path.join(data_folder, "Annual_Predictions_Mitlenatch_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Mitlenatch_2024.csv")])
#     # well_df = import_aquarius_data(os.path.join(data_folder, "MASL_OW511.csv"))
#     # main('OW511','Mitlenatch', shore_df, shore_x_col, shore_y_col, 3.2, well_df, well_x_col, well_y_col, 100, [0.030, 23, 4.5, 0.9], fit_fn, 155, 12.67*3600, 20, 5) 
...
shore_df = import_shore_data([os.path.join(data_folder, "Annual_Predictions_Mitlenatch_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Mitlenatch_2024.csv")])
well_df = import_aquarius_data(os.path.join(data_folder, "MASL_OW408.csv"))
main('OW408','Mitlenatch', shore_df, shore_x_col, shore_y_col, 3.2, well_df, well_x_col, well_y_col, 100, [0.030, 23, 4.5, 0.9], fit_fn, 306, 12.67*3600, 1, 1.9) 

# shore_df = import_aquarius_data(os.path.join(data_folder, "08MH0047.csv"))
# well_df = import_aquarius_data(os.path.join(data_folder, "MASL_OW452.csv"))
# main('OW452','Mitlenatch', shore_df, 'Timestamp (UTC)', 'Value (m)', 0, well_df, well_x_col, well_y_col, 100, [0.030, 23, 4.5, 0.9], fit_fn, 681, 12.67*3600, 8, 1.7) 

# shore_df = import_shore_data([os.path.join(data_folder, "Annual_Predictions_Roberts Creek_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Roberts Creek_2024.csv")])
# well_df = import_aquarius_data(os.path.join(data_folder, "MASL_OW499.csv"))
# main('OW499','Roberts Creek', shore_df, shore_x_col, shore_y_col, 1.23, well_df, well_x_col, well_y_col, 100, [0.030, 23, 4.5, 0.9], fit_fn, 782, 12.67*3600, 8, 2) 

# shore_df = import_shore_data([os.path.join(data_folder, "Annual_Predictions_Point Atkinson_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Point Atkinson_2024.csv")])
# well_df = import_aquarius_data(os.path.join(data_folder, "MASL_OW473.csv"))
# main('OW473','Point Atkinson', shore_df, shore_x_col, shore_y_col, -86, well_df, well_x_col, well_y_col, 100, None, composite_sine, 280, 12.67*3600, 8, 2) 

# shore_df = import_shore_data([os.path.join(data_folder, "Annual_Predictions_Sandy Cove_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Sandy Cove_2024.csv")])
# well_df = import_aquarius_data(os.path.join(data_folder, "MASL_OW473.csv"))
# main('OW473','Sandy Cove', shore_df, shore_x_col, shore_y_col, -86, well_df, well_x_col, well_y_col, 100, None, composite_sine, 280, 12.67*3600, 8, 2) 


# shore_df = import_shore_data([os.path.join(data_folder, "Annual_Predictions_Sand Heads_2023.csv"), os.path.join(data_folder, "Annual_Predictions_Sand Heads_2024.csv")])
# well_df = import_aquarius_data(os.path.join(data_folder, "MASL_OW473.csv"))
# main('OW473','Sandy Cove', shore_df, shore_x_col, shore_y_col, -86, well_df, well_x_col, well_y_col, 100, None, composite_sine, 280, 12.67*3600, 8, 2) 
